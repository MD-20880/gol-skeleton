...
benchmark_data['threads'] = benchmark_data['name'].str.extract('Gol/512x512x100-(\d+)-\d+').apply(pd.to_numeric)
benchmark_data['cpu_cores'] = benchmark_data['name'].str.extract('Gol/512x512x100-\d+-(\d+)').apply(pd.to_numeric)
